      ...
      <section className="hidden md:col-span-1 lg:col-span-2 md:flex justify-center items-center">
        <div className="lg:w-[70%] px-5 space-y-10 ">
          <div className="space-y-2 font-bold text-center">
            ...
            <p className="text-primary-color">Boost your sales today</p>
          </div>
          <img
            className="w-[550px]"
            src="https://file.hstatic.net/200000472237/file/398-ban-hang-ca-nhan-la-gi-4_01016329284b4a15a7d5d5e2b5efd24c.jpg"
            alt=""
          />
        </div>
      </section>
